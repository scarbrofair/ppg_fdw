-- an example script to setup a cluster with 2 nodes in local machine 
-- and create foreign table for tpch data set 
-- Note: 2 nodes of pgsql is run with port 5431 and 5430, and can be access with user postgres with empty pwd
...
CREATE FOREIGN TABLE NATION  ( N_NATIONKEY  INTEGER NOT NULL,
                            ...
                            N_COMMENT    VARCHAR(152)) SERVER testserver1;

CREATE FOREIGN TABLE REGION  ( R_REGIONKEY  INTEGER NOT NULL,
                            R_NAME       CHAR(25) NOT NULL,
                            R_COMMENT    VARCHAR(152)) SERVER testserver1;
...
CREATE FOREIGN TABLE PART  ( P_PARTKEY     INTEGER NOT NULL,
                          ...
                          P_COMMENT     VARCHAR(23) NOT NULL ) SERVER testserver1;
...
CREATE FOREIGN TABLE SUPPLIER ( S_SUPPKEY     INTEGER NOT NULL,
                             ...
                             S_COMMENT     VARCHAR(101) NOT NULL) SERVER testserver1;

CREATE FOREIGN TABLE PARTSUPP ( PS_PARTKEY     INTEGER NOT NULL,
                             PS_SUPPKEY     INTEGER NOT NULL,
                             PS_AVAILQTY    INTEGER NOT NULL,
                             PS_SUPPLYCOST  DECIMAL(15,2)  NOT NULL,
                             PS_COMMENT     VARCHAR(199) NOT NULL ) SERVER testserver1;
...
CREATE FOREIGN TABLE CUSTOMER ( C_CUSTKEY     INTEGER NOT NULL,
                             ...
                             C_COMMENT     VARCHAR(117) NOT NULL) SERVER testserver1;
...
CREATE FOREIGN TABLE LINEITEM ( L_ORDERKEY    INTEGER NOT NULL,
                             ...
                             L_COMMENT      VARCHAR(44) NOT NULL) SERVER testserver1;
